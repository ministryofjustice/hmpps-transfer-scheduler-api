...
class TransferController(
  private val initiate: InitiateTransfer,
  private val retrieve: RetrieveTransfer,
  private val history: TransferHistoryService,
  private val modifications: TransferModifications,
) {
  @CaseloadIdHeader
  ...
  ): Transfer = initiate.transferFor(personIdentifier, request)
  ...
  @CaseloadIdHeader
  @PutMapping("/{id}")
  fun applyActions(@PathVariable id: UUID, @Valid @RequestBody request: TransferActions): AuditHistory = modifications.apply(id, request)
}

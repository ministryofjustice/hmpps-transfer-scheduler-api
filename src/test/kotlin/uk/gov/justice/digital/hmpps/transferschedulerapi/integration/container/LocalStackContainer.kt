package uk.gov.justice.digital.hmpps.transferschedulerapi.integration.container
...
object LocalStackContainer {
  ...
  fun setMiniStackProperties(miniStackContainer: GenericContainer<*>, registry: DynamicPropertyRegistry) {
  ...
  private fun miniStackIsRunning(): Boolean = try {

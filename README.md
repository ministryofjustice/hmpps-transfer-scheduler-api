...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-transfer-scheduler-api/security/policy).
...
## Renaming from HMPPS Transfer Scheduler Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-transfer-scheduler-api=0
```
